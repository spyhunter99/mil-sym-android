...
public class SymbolModifiers {
    ...
    public ArrayList<Double> X_ALTITUDE_DEPTH = new ArrayList<Double>();
    public String Y_LOCATION = "";
    public ArrayList<Double> AM_DISTANCE = new ArrayList<Double>();
    public ArrayList<Double> AN_AZIMUTH = new ArrayList<Double>();
