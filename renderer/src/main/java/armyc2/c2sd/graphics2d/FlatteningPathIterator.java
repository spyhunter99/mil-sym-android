/*
 * @(#)FlatteningPathIterator.java	1.17 05/11/17
 *
...
public class FlatteningPathIterator /*implements PathIterator */{
    ...
    ArcIterator src;			// The source iterator
     ...
     */
    public FlatteningPathIterator(ArcIterator src, double flatness) {
    ...
    private void next2(boolean doNext) {
	int level;
