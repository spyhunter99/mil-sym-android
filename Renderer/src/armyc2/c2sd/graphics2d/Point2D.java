...
public abstract class Point2D implements Cloneable{
    ...
    public static class Float extends Point2D implements Serializable {
         ...
         * <code>Point2D</code>
        Point2D.java : » App » android-app-examples » org » loon » framework » android » gam... Page 1 of 6
     ...
     * <code>double</code> precision.
     *
    Point2D.java : » App » android-app-examples » org » loon » framework » android » gam... Page 3 of 6
    http://www.java2s.com/Open-Source/Android/App/android-app-examples/org/loon/frame... 2/25/2013
    ...
    Point2D.java : » App » android-app-examples » org » loon » framework » android » gam... Page 4 of 6
    http://www.java2s.com/Open-Source/Android/App/android-app-examples/org/loon/frame... 2/25/2013
    ( t he s pe c i f i e d poi nt .
    ( ) s i nc e 1. 2
    ( /
    public double di s t a nc e S* + double px, double p- . /
    px - 0 ge t 1 + . 2
    p- - 0 ge t 3 + . 2
    return + px ( px 4 p- ( p- . 2
    5
    / ( (
    ( 6 e t ur ns t he s * ua r e of t he di s t a nc e f r om t hi s 7 c ode 8 Poi nt 2D7 / c ode 8 t o a
    ( s pe c i f i e d 7 c ode 8 Poi nt 2D7 / c ode 8 .
    (
    ( ) pa r am pt
    ( t he s pe c i f i e d poi nt t o 9 e me a s ur e d a ga i ns t t hi s
    ( 7 c ode 8 Poi nt 2D7 / c ode 8
    ( ) r e t ur n t he s * ua r e of t he di s t a nc e 9 e t we e n t hi s 7 c ode 8 Poi nt 2D7 / c ode 8 t o a
    ( s pe c i f i e d 7 c ode 8 Poi nt 2D7 / c ode 8 .
    ( ) s i nc e 1. 2
    ( /
    public double di s t a nc e S* + Poi nt 2D pt . /
    double px 0 pt . ge t 1 + . - t hi s . ge t 1 + . 2
    double p- 0 pt . ge t 3 + . - t hi s . ge t 3 + . 2
    return + px ( px 4 p- ( p- . 2
    5
    / ( (
    ( 6 e t ur ns t he di s t a nc e f r om t hi s 7 c ode 8 Poi nt 2D7 / c ode 8 t o a s pe c i f i e d poi nt .
    (
    ( ) pa r am px
    ( t he 1 c oor di na t e of t he s pe c i f i e d poi nt t o 9 e me a s ur e d a ga i ns t
    ( t hi s 7 c ode 8 Poi nt 2D7 / c ode 8
    ( ) pa r am p-
    ( t he 3 c oor di na t e of t he s pe c i f i e d poi nt t o 9 e me a s ur e d a ga i ns t
    ( t hi s 7 c ode 8 Poi nt 2D7 / c ode 8
    ( ) r e t ur n t he di s t a nc e 9 e t we e n t hi s 7 c ode 8 Poi nt 2D7 / c ode 8 a nd a s pe c i f i e d
    ( poi nt .
    ( ) s i nc e 1. 2
    ( /
    public double di s t a nc e + double px, double p- . /
    px - 0 ge t 1 + . 2
    p- - 0 ge t 3 + . 2
    return : a t h. s * r t + px ( px 4 p- ( p- . 2
    5
    / ( (
    ( 6 e t ur ns t he di s t a nc e f r om t hi s 7 c ode 8 Poi nt 2D7 / c ode 8 t o a s pe c i f i e d
    ( 7 c ode 8 Poi nt 2D7 / c ode 8 .
    (
    ( ) pa r am pt
    ( t he s pe c i f i e d poi nt t o 9 e me a s ur e d a ga i ns t t hi s
    ( 7 c ode 8 Poi nt 2D7 / c ode 8
    ( ) r e t ur n t he di s t a nc e 9 e t we e n t hi s 7 c ode 8 Poi nt 2D7 / c ode 8 a nd t he s pe c i f i e d
    ( 7 c ode 8 Poi nt 2D7 / c ode 8 .
    ( ) s i nc e 1. 2
    ( /
    public double di s t a nc e + Poi nt 2D pt . /
    double px 0 pt . ge t 1 + . - t hi s . ge t 1 + . 2
    double p- 0 pt . ge t 3 + . - t hi s . ge t 3 + . 2
    return : a t h. s * r t + px ( px 4 p- ( p- . 2
    5
    / ( (
    ( ; r e a t e s a new o9 j e c t of t he s ame c l a s s a nd wi t h t he s ame c ont e nt s a s t hi s
    ( o9 j e c t .
    (
    ( ) r e t ur n a c l one of t hi s i ns t a nc e .
    ( ) e xc e pt i on Out Of : emor - < r r or
    ( i f t he r e i s not e nough memor - .
    ( ) s e e j a va . l a ng. ; l one a 9 l e
    ( ) s i nc e 1. 2
    ( /
    public O9 j e c t c l one + . /
    try /
    return s upe r . c l one + . 2
    5 catch + ; l one = ot Suppor t e d< xc e pt i on e . /
    / / t hi s s houl dn> t ha ppe n, s i nc e we a r e ; l one a 9 l e
    throw new ? nt e r na l < r r or + . 2
    5
    5
    / ( (
    ( 6 e t ur ns t he ha s hc ode f or t hi s 7 c ode 8 Poi nt 2D7 / c ode 8 .
    (
    ( ) r e t ur n a ha s h c ode f or t hi s 7 c ode 8 Poi nt 2D7 / c ode 8 .
    ( /
    public int ha s h; ode + . /
    long 9 i t s 0 j a va . l a ng. Dou9 l e . dou9 l e @ oA ongB i t s + ge t 1 + . . 2
    9 i t s C 0 j a va . l a ng. Dou9 l e . dou9 l e @ oA ongB i t s + ge t 3 + . . ( 312
    return + + + int. 9 i t s . C + + int. + 9 i t s 8 8 32. . . 2
    5
    Point2D.java : » App » android-app-examples » org » loon » framework » android » gam... Page 5 of 6
    http://www.java2s.com/Open-Source/Android/App/android-app-examples/org/loon/frame... 2/25/2013
    /**
