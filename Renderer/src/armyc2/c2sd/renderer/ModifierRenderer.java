...
//                        width++;
        ...
        if(fdiBounds != null)
        {
        	...
        	fdiPaint.setPathEffect(new DashPathEffect(new float[]{6,4},0));
            ...
            {
            	fdiPaint.setPathEffect(new DashPathEffect(new float[]{5,3},0));
            }
...
//                    x = x - (labelBounds.width * 0.5);
    ...
    public static boolean hasTextModifiers(String symbolID, SparseArray<String> modifiers, SparseArray<String> attributes)
    {
        ...
        if(scheme=='G')
        {
            ...
            String allowedModifiers = sd.getModifiers();
            if(allowedModifiers != null && allowedModifiers.equals("") == false)
            {
                String[] tgSpecificKeys = allowedModifiers.split(".");//modifiers for this specific symbol
                int len = tgSpecificKeys.length;
