...
final class Order3 /* extends Curve */ {
    ...
    public static int getHorizontalParams(double c0, double cp0,
        ...
        int numroots = Curve.solveQuadratic(ret, ret);
        int j = 0;
    ...
    public double getX0() {
        return (direction == Curve.INCREASING) ? x0 : x1;
    }

    public double getY0() {
        return (direction == Curve.INCREASING) ? y0 : y1;
    }

    public double getCX0() {
        return (direction == Curve.INCREASING) ? cx0 : cx1;
    }

    public double getCY0() {
        return (direction == Curve.INCREASING) ? cy0 : cy1;
    }

    public double getCX1() {
        return (direction == Curve.DECREASING) ? cx0 : cx1;
    }

    public double getCY1() {
        return (direction == Curve.DECREASING) ? cy0 : cy1;
    }

    public double getX1() {
        return (direction == Curve.DECREASING) ? x0 : x1;
    }

    public double getY1() {
        return (direction == Curve.DECREASING) ? y0 : y1;
    }
    ...
    public double refine(double a, double b, double c,
        ...
        if (false && t >= 0 && t <= 1) {
            y = YforT(t);
            long tdiff = Curve.diffbits(t, origt);
            long ydiff = Curve.diffbits(y, origy);
            long yerr = Curve.diffbits(y, target);
            if (yerr > 0 || (verbose && tdiff > 0)) {
                ...
                double tlow = Curve.prev(t);
                double ylow = YforT(tlow);
                double thi = Curve.next(t);
    ...
    public double nextVertical(double t0, double t1) {
        ...
        int numroots = Curve.solveQuadratic(eqn, eqn);
        for (int i = 0; i < numroots; i++) {
    ...
    public Order3 getWithDirection(int direction) {
        return (this.direction == direction ? this : getReversedCurve());
    }

    public Order3 getSubCurve(double ystart, double yend, int dir) {    //did return curve
    ...
    public Order3 getReversedCurve() {  //did return Curve
