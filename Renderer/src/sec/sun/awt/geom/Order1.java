...
final class Order1 /* extends Curve */ {
    ...
    public Order1 getSubCurve(double ystart, double yend, int dir) {    //did return Curve
    ...
    public Order1 getReversedCurve() {  //did return Curve
    ...
    public int compareTo(Object other, double yrange[]) {   //other was Curve
        ...
        return Curve.orderof(XforY(y), c1.XforY(y));
    }
